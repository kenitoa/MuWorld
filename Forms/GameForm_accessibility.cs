...
public sealed partial class GameForm
{
    ...
    private void RebuildAccessibleNodes()
    {
        ...
        switch (_screen)
        {
            case UiScreen.MainMenu:
                ...
                AddAccessibleNode("Statistics", "Open statistics.", GetMenuActionButtonBounds(2), AccessibleRole.PushButton, () => OpenMainMenuAction(2));
                AddAccessibleNode("Settings", "Open settings.", Rectangle.Union(GetMenuActionButtonBounds(0), GetMenuTopSettingsButtonBounds()), AccessibleRole.PushButton, () => OpenMainMenuAction(0));
            ...
            case UiScreen.Achievement:
                AddAccessibleNode("Bronze Achiever", "Open bronze achievement details.", GetAchievementCardBounds(0), AccessibleRole.PushButton, () => OpenAchievementCard(0));
                AddAccessibleNode("Silver Achiever", "Open silver achievement details.", GetAchievementCardBounds(1), AccessibleRole.PushButton, () => OpenAchievementCard(1));
                AddAccessibleNode("Star Player", "Open star player achievement details.", GetAchievementCardBounds(2), AccessibleRole.PushButton, () => OpenAchievementCard(2));
            ...
            case UiScreen.Analyze:
                AddAccessibleNode("OK", "Return to main menu.", GetAnalyzeOkButtonBounds(), AccessibleRole.PushButton, () => HandleAnalyzeMouseDown(GetAnalyzeOkButtonBounds().Center()));
                break;
    ...
    private void AddSettingsAccessibleNodes()
    {
        ...
        AddAccessibleNode("Display mode", "Toggle windowed or full screen.", GetSettingsSegmentBounds("display"), AccessibleRole.ComboBox, () => HandleSettingsMouseDown(GetSettingsSegmentBounds("display").Center()));
        AddSliderNode("Lane brightness", "Adjust lane brightness.", SettingsSlider.LaneBrightness);
        ...
        AddAccessibleNode("Play mode", "Cycle normal or practice play mode.", GetSettingsSegmentBounds("playmode"), AccessibleRole.ComboBox, () => CyclePlayMode(1), delta => CyclePlayMode(delta));
    ...
    private void CycleHitSoundSkin(int delta)
    {
        ...
        _hitSoundSkinIndex = (_hitSoundSkinIndex + Math.Sign(delta) + labels.Length) % labels.Length;
